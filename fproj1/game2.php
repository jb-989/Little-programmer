...
<body>
    ...
    <div class="question-box">
        ...
        <div class="question-main">To change text color: &lt;body text="__________"&gt;</div>
    </div>
...
<div class="question-row">
    <div class="question-box">
        <div class="question-side"></div>
        <div class="question-main">The &lt;b&gt; tag makes text ______.</div>
    </div>
    <div class="answer-box" data-question="7">
        <img src="https://cdn-icons-png.flaticon.com/512/190/190411.png" class="feedback-icon correct" alt="Correct">
        <img src="https://cdn-icons-png.flaticon.com/512/1828/1828843.png" class="feedback-icon incorrect" alt="Incorrect">
    </div>
</div>
...
<div class="question-row">
    <div class="question-box">
        <div class="question-side"></div>
        <div class="question-main">An ordered list uses the &lt;__&gt; tag.</div>
    </div>
    <div class="answer-box" data-question="8">
        <img src="https://cdn-icons-png.flaticon.com/512/190/190411.png" class="feedback-icon correct" alt="Correct">
        <img src="https://cdn-icons-png.flaticon.com/512/1828/1828843.png" class="feedback-icon incorrect" alt="Incorrect">
    </div>
</div>
...
<div class="question-row">
    <div class="question-box">
        <div class="question-side"></div>
        <div class="question-main">&lt;p align="right"&gt; aligns the paragraph to the ______.</div>
    </div>
    <div class="answer-box" data-question="9">
        <img src="https://cdn-icons-png.flaticon.com/512/190/190411.png" class="feedback-icon correct" alt="Correct">
        <img src="https://cdn-icons-png.flaticon.com/512/1828/1828843.png" class="feedback-icon incorrect" alt="Incorrect">
    </div>
</div>
    ...
    <script>
        ...
        { text: "ol", correctAnswer: 8 },
        { text: "bold", correctAnswer: 7 },
        { text: "#FF0000", correctAnswer: 6 },
        { text: "right", correctAnswer: 9 }
          ];       
