...
<body>
    ...
    <div class="question-box">
        ...
        <div class="question-main">The HTML tag &lt;button&gt;Save&lt;/button&gt; is used for ______.</div>
    </div>
    <div class="answer-box" data-question="10">
...
<div class="question-row">
    <div class="question-box">
        <div class="question-side"></div>
        <div class="question-main">The onmouseover event is used to zoom an ______.</div>
    </div>
    <div class="answer-box" data-question="11">
        <img src="https://cdn-icons-png.flaticon.com/512/190/190411.png" class="feedback-icon correct" alt="Correct">
        <img src="https://cdn-icons-png.flaticon.com/512/1828/1828843.png" class="feedback-icon incorrect" alt="Incorrect">
    </div>
</div>
...
<div class="question-row">
    <div class="question-box">
        <div class="question-side"></div>
        <div class="question-main">In CSS, background-color, padding, and border-radius are used to style a ______.</div>
    </div>
    <div class="answer-box" data-question="12">
        <img src="https://cdn-icons-png.flaticon.com/512/190/190411.png" class="feedback-icon correct" alt="Correct">
        <img src="https://cdn-icons-png.flaticon.com/512/1828/1828843.png" class="feedback-icon incorrect" alt="Incorrect">
    </div>
</div>
...
<div class="question-row">
    <div class="question-box">
        <div class="question-side"></div>
        <div class="question-main">Instructing means giving ______ to the system.</div>
    </div>
    <div class="answer-box" data-question="13">
        <img src="https://cdn-icons-png.flaticon.com/512/190/190411.png" class="feedback-icon correct" alt="Correct">
        <img src="https://cdn-icons-png.flaticon.com/512/1828/1828843.png" class="feedback-icon incorrect" alt="Incorrect">
    </div>
</div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            { text: "instructing", correctAnswer: 10 },
            { text: "image", correctAnswer: 11 },
            { text: "button", correctAnswer: 12 },
            { text: "commands", correctAnswer: 13 }
           ];
