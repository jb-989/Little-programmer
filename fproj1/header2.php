  ...
  <style>
    * {
    ...
    .footer {
      ...
      height: 40px; /* حجم الصورة */
      border-radius: 50%; /* لجعل الصورة دائرية */
      cursor: pointer; /* تغيير المؤشر عند تمرير الفأرة */
...
<header>
    ...
    <nav>
      ...
      <!-- <button class="program-button" onclick="document.getElementById('myPopup').style.display='block'">Programs</button> -->
      <a href="contactus.php" class="nav-button">Contact Us</a>
      <a href="start_video.php" class="nav-button">Lessons</a>
      <a href="Board.php" class="nav-button">Board</a>
       <a href="prof.php">
          <img src="https://i.ibb.co/qMKVqNK3/prof.jpg" alt="profile" class="goal-image"> <!-- استبدل بمسار الصورة -->
        </a>
    </nav>
  </header>
  ...
  <!-- <div id="myPopup" class="popup-container">
    <div class="popup-content">
      <span class="close-button" onclick="document.getElementById('myPopup').style.display='none'">&times;</span>

      <div class="popup-item" onclick="navigateTo('start_video.php')">
        <img src="https://i.ibb.co/V0vgym0K/video.png" alt="Educational Videos">
        <span>Educational videos</span>
      </div>

      <div class="popup-item" onclick="navigateTo('Board.php')">
        <img src="https://i.ibb.co/GvV8kq2K/coding-board-icon.png" alt="Coding Board">
        <span>Coding Board</span>
      </div>

      <div class="popup-item" onclick="navigateTo('robot-language.php')">
        <img src="https://i.ibb.co/FbbpMZZd/robot-lang.webp" alt="Robot Language">
