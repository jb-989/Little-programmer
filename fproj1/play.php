            ...
            <div class="questions-container">
                <div class="question-row">
                    <div class="question-box">
                        ...
                        <div class="question-main">Which coding statement is used to display text on screen?</div>
                    </div>
                ...
                <div class="question-row">
                    <div class="question-box">
                        <div class="question-side"></div>
                        <div class="question-main">What do we use to store data in programming?</div>
                    </div>
                ...
                <div class="question-row">
                    <div class="question-box">
                        <div class="question-side"></div>
                        <div class="question-main">Which statement repeats multiple times based on a condition?</div>
                    </div>
                ...
                <div class="question-row">
                    <div class="question-box">
                        <div class="question-side"></div>
                        <div class="question-main">What do we use to make decisions in programming?</div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const programmingWords = [
                { text: "print()", correctAnswer: 1 },
                { text: "Variables", correctAnswer: 2 },
                { text: "Loop", correctAnswer: 3 },
                { text: "If statement", correctAnswer: 4 },
                { text: "Else", correctAnswer: 4 },
                { text: "For", correctAnswer: 3 },
                { text: "Arrays", correctAnswer: 2 },
                { text: "console.log()", correctAnswer: 1 }
            ];
